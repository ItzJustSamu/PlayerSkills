...
public class MessageConfig extends PathableConfig {
    ...
    public static final StringConfigPath MENU_Worlds_Restrictions = new StringConfigPath(new PathString("menu-world-restriction"), "&cYou cannot modify your skills in your current location.");
