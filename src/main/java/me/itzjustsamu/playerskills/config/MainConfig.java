...
public class MainConfig extends PathableConfig {
    ...
    public static final StringListConfigPath OPTIONS_DISABLED_SKILLS = new StringListConfigPath(new PathString("options", "disabled-skills"), Collections.emptyList());
