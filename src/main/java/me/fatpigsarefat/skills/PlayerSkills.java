...
/*  32 */     return instance;
/*     */   } public static FileManager fileManager; public static SkillManager skillManager; public static FileManager getFileManager() {
...
/*     */     }
/*     */     
/*  82 */     Bukkit.getPluginManager().registerEvents(new InventoryClick(), this);
/*  83 */     Bukkit.getPluginManager().registerEvents(new EntityDamageByEntity(), this);
/*  84 */     Bukkit.getPluginManager().registerEvents(new EntityDamage(), this);
/*  85 */     Bukkit.getPluginManager().registerEvents(new PlayerListener(), this);
/*  86 */     Bukkit.getPluginManager().registerEvents(new UpgradeSkill(), this);
/*  87 */     Bukkit.getPluginManager().registerEvents(new ResetSkill(), this);
/*  88 */     Bukkit.getPluginCommand("me/fatpigsarefat/skills").setExecutor(new SkillsCommand());
/*  89 */     Bukkit.getPluginCommand("skillsadmin").setExecutor(new SkillsAdminCommand());
/*  90 */     checkIfHealth();
/*  91 */     for (String s : fileManager.getConfig("config").get().getConfigurationSection("me/fatpigsarefat/skills").getKeys(false)) {
...
/*  95 */     checkUpdates(null);
/*     */   }
/*     */
/*     */   public void checkIfHealth() {
/*  99 */     BukkitScheduler healthCheck = getServer().getScheduler();
/* 100 */
    int i = healthCheck.scheduleSyncRepeatingTask((Plugin) this, new Runnable() {
        /*     */
        public void run() {
            /* 102 */
